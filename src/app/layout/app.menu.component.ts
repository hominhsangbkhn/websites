    ...
    ngOnInit() {
        this.model = [
            ...
            },
            {
                ...
                routerLink: ['/apps/screen-manual']
            },
            {
                label: 'ERROR',
                icon: 'pi pi-fw pi-times',
                routerLink: ['/apps/screen-error-list']
            },
            {
                label: 'SETTING',
                icon: 'pi pi-fw pi-cog',
                routerLink: ['/apps/screen-setting']
            },
            {
                label: 'IO MONITOR',
                icon: 'pi pi-fw pi-bolt',
                routerLink: ['/apps/screen-io']
            },
            {
                label: 'CONDITION',
                icon: 'pi pi-fw pi-hashtag',
                routerLink: ['/apps/screen-condition']
            },
            {
                label: 'PARAMETER',
                icon: 'pi pi-fw pi-database',
                routerLink: ['/apps/screen-params']
            },
            // {
            //     label: 'Dashboards',
            //     icon: 'pi pi-home',
